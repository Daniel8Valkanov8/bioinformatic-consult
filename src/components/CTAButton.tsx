...
const styles: Record<Variant, string> = {
  primary:
    "bg-signal text-carbon font-semibold hover:bg-signal-soft shadow-[0_0_30px_-8px_rgba(77,155,255,0.55)]",
  secondary:
    "border border-line bg-surface/60 text-fg hover:border-signal/60 hover:text-signal",
};
